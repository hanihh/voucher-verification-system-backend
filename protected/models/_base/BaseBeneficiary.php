...
abstract class BaseBeneficiary extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('status_id, neighborhood_id, birth_year, gender, nationality_id, family_member', 'numerical', 'integerOnly'=>true),
			array('registration_code', 'length', 'max'=>20),
			array('ar_name, en_name, father_name, mother_name', 'length', 'max'=>255),
			...
			array('create_date, update_date, status_id, neighborhood_id, deleted_at, remote_image, ar_name, father_name, mother_name, birth_year, gender, nationality_id, phone_number, family_member, main_income_source, combine_household', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, create_date, update_date, registration_code, status_id, neighborhood_id, deleted_at, remote_image, ar_name, en_name, father_name, mother_name, birth_year, gender, nationality_id, phone_number, family_member, main_income_source, combine_household', 'safe', 'on'=>'search'),
		);
	}
