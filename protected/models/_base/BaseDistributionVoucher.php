...
abstract class BaseDistributionVoucher extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('subdistribution_id, type_id', 'required'),
			array('subdistribution_id, type_id', 'numerical', 'integerOnly'=>true),
			array('value', 'numerical'),
			array('expiration_date, create_date, deleted_at', 'safe'),
			array('expiration_date, create_date, deleted_at, value', 'default', 'setOnEmpty' => true, 'value' => null),
