...
abstract class BaseVoucher extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('deleted_at, redeem_date, sync_date', 'safe'),
			array('ben_id, vendor_id, deleted_at, redeem_date, sync_date', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, code, distribution_voucher_id, ben_id, vendor_id, status_id, create_date, deleted_at, redeem_date, sync_date', 'safe', 'on'=>'search'),
		);
	}
