<div class="view">
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('arabic_text')); ?>:
	<?php echo GxHtml::encode($data->arabic_text); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('english_text')); ?>:
	<?php echo GxHtml::encode($data->english_text); ?>
	<br />
